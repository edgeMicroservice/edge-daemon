...
const initialize = (optionSecurityHandlers) => {
  ...
  const securityHandlers = optionSecurityHandlers || {
      ...
      SystemSecurity: noSecurityHandler,
  };
  ...
  "AdminSecurity": {
    ...
    "scopes": {
      ...
      "read:nodeDetails": "read node details"
    }
  },
  "SystemSecurity": {
    "type": "oauth2",
  ...
  mw.post(
    '/nodes',
    swaggerPreParse({ operationId: 'createNode' }),
    swaggerSecurities(createNodeSecurities),
    swaggerParams(createNodeParams, { operationId: 'createNode' }),
    (nodeController && nodeController.createNode)
      || notImplemented('post', '/nodes', 'createNode'),
  );
  /* eslint-enable */
  /* eslint-disable */
  ...
  mw.delete(
    '/nodes/:id',
    swaggerPreParse({ operationId: 'deleteNode' }),
    swaggerSecurities(deleteNodeSecurities),
    swaggerParams(deleteNodeParams, { operationId: 'deleteNode' }),
    (nodeController && nodeController.deleteNode)
      || notImplemented('delete', '/nodes/:id', 'deleteNode'),
  );
  /* eslint-enable */
